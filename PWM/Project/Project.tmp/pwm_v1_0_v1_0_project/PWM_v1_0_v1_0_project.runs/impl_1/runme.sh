...
HD_PWD='e:/ece532/pwm/project/project.tmp/pwm_v1_0_v1_0_project/PWM_v1_0_v1_0_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PWM_v1_0.vdi -applog -m64 -messageDb vivado.pb -mode batch -source PWM_v1_0.tcl -notrace
