...
HD_PWD='e:/ece532/pwm/project/project.tmp/pwm_v1_0_v1_0_project/PWM_v1_0_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PWM_v1_0.vds -m64 -mode batch -messageDb vivado.pb -notrace -source PWM_v1_0.tcl
