...
module vga_controller (
    ...
    assign mem_addra = (edge_valid || edge_valid2) ? (ed_y-4)*width + ed_x-4 : ed_y*width + ed_x; 
    assign mem_dina = (edge_valid || edge_valid2) ? 2'b10 /*green*/ :
        (colour2 ? 2'b11 /*white*/ :
        (colour ? 2'b01 /*red*/ :
            2'b00 /*black*/));
            
    wire in_range;
    assign in_range = row < 480 && column < 640;
    assign mem_addrb = in_range ? row*640 + column : 0;
    ...
    VGAdrive vgadriver_inst (
        ...
        .blue(in_range ? (mem_doutb[0] & mem_doutb[1]) : 0),
        .row(row),
        .column(column),
        //vga drive signals
        .Rout(r1),
