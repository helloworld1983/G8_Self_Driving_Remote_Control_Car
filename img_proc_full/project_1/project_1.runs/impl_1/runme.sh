...
HD_PWD='C:/Users/yy/Desktop/ece532_debug/img_proc_full/jpeg.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log stream_jpg_yy_nv_mn_v1_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source stream_jpg_yy_nv_mn_v1_0.tcl -notrace
