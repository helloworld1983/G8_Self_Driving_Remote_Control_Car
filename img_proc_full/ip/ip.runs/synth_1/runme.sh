...
HD_PWD='C:/Users/yy/Desktop/ece532_debug/img_proc_full/jpeg.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log stream_jpg_yy_nv_mn_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source stream_jpg_yy_nv_mn_v1_0.tcl
